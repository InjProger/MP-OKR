...
namespace MissionPlanner.Controls
{
    public class HUD : GLControl
    {
        ...
        void doPaint()
        {
            ...
            try
            {
                ...
                if (status == false) // not armed
                {
                    ...
                    {
                        drawstring(HUDT.DISARMED, font, fontsize + 10, (SolidBrush) Brushes.Red, -60,
                            halfheight / -3);
                        statuslast = status;
                    }
                }
                ...
                if (failsafe == true)
                {
                    drawstring(HUDT.FAILSAFE, font, fontsize + 20, (SolidBrush) Brushes.Red, -75,
                ...
                if (message != "")
                {
                    ...
                    drawstring(message, font, newfontsize, (SolidBrush) Brushes.Red, -halfwidth + 70,
                        halfheight / 3);
                }
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "HUD";
            this.Size = new System.Drawing.Size(529, 498);
