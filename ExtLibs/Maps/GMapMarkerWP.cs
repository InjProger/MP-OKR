...
namespace MissionPlanner.Maps
{
    ...
    public class GMapMarkerWP : GMarkerGoogle
    {
        ...
        public GMapMarkerWP(PointLatLng p, GMarkerGoogleType markerGoogleType, string wpno = "")
            : base(p, markerGoogleType)
        {
            this.wpno = wpno;
            ...
            if (!fontBitmaps.ContainsKey(wpno) && wpno != "Home")
            {
        ...
        public override void OnRender(IGraphics g)
        {
            ...
            if ( wpno != "Home" && ( Overlay.Control.Zoom > 16 || IsMouseOver ) )
            {
