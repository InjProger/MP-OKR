...
namespace MissionPlanner.Controls
{
    public partial class MovingBase : Form
    {
        ...
        public MovingBase ( Port Port ) : this( )
        {
            CMB_serialport.Text = Port.Name;
            CMB_baudrate.Text = Port.Baudrate.ToString( );
            //CMB_updaterate.Text = movingBaseEntity.Updaterate.ToString();
        }
