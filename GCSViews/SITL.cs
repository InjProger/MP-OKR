...
namespace MissionPlanner.GCSViews
{
    public partial class SITL : MyUserControl, IActivate
    {
        ...
        GMapMarkerWP homemarker = new GMapMarkerWP(new PointLatLng(-34.98106, 117.85201), GMarkerGoogleType.home, "Home");
        bool onmarker = false;
...
", a + 1));
            ...
            try
            {
                ...
                try
                {
                    MainV2.ComPort.getParamList((byte)MainV2.ComPort.sysidcurrent, (byte)MainV2.ComPort.compidcurrent);
                }
                catch
                {
                }
