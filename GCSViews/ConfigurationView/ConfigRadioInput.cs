...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigRadioInput : MyUserControl, IActivate, IDeactivate
    {
        ...
        private SDL.Joysticks.Joystick j;
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            f1Bar.Value = state.Buttons[ 19 ] ? 2200 : 800;

            var cs = MainV2.ComPort.MAV.cs;

            //f1Bar.Value = (int) cs.ch14out;
            f2Bar.Value = BAR7.Value;
            fuse1Bar.Value = (int) cs.ch6out;
            fuse2Bar.Value = (int) cs.ch10out;
            fire1Bar.Value = (int) cs.ch5out;
            fire2Bar.Value = (int) cs.ch9out;

            BARyawMin.Value = BARyaw.Value;
        ...
        {
            new ConfigFlightModes( ).ShowUserControl( );
        }

        private void ConfigRadioInput_FormClosed ( object sender, FormClosedEventArgs e )
        {
            _timer.Stop( );
            j.Dispose( );
        }
